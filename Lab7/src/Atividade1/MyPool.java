package Atividade1;/* Disciplina: Programacao Concorrente */
...
class Primo implements Runnable {
    ...
    public void run() {
        ...
        System.out.println("Número " + numero + (resultado ? " é primo." : " não é primo."));
    }
}
...
class MyPool {
    ...
    public static void main (String[] args) {
      ...
      for (int i = 0; i < 25; i++) {
        ...
        pool.execute(hello);
        Runnable primo = new Atividade1.Primo(i);
        pool.execute(primo);
      }
